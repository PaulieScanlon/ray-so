  ...
  mastra: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        parameter: "#A26A00",
        function: "#6E2587",
        stringExpression: "#326631",
        punctuation: "#0F0F0F",
        link: "#326631",
        number: "#0F0F0F",
        property: "#0F0F0F",
        highlight: "rgba(50, 102, 49, 0.08)",
        highlightBorder: "#326631",
        highlightHover: "rgba(50, 102, 49, 0.04)",
        diffDeleted: "#6A6A6A",
        diffInserted: "#326631",
      }),
      dark: convertToShikiTheme({
        ...
        parameter: "#FFA94B",
        function: "#BE96FF",
        stringExpression: "#72FF70",
        punctuation: "#F2F2F2",
        link: "#72FF70",
        number: "#F2F2F2",
        property: "#F2F2F2",
        highlight: "rgba(114, 255, 112, 0.1)",
        highlightBorder: "#72FF70",
        highlightHover: "rgba(114, 255, 112, 0.05)",
        diffDeleted: "#939393",
        diffInserted: "#72FF70",
      }),
    },
